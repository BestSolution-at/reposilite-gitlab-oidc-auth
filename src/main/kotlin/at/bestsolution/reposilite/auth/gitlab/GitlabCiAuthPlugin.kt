...
class GitlabCiAuthPlugin : ReposilitePlugin() {
    ...
    override fun initialize(): Facade? {
        ...
        require(config.ciReadRepositories.isNotEmpty()) { "gitlab-ci-auth: ciReadRepositories is required" }
        require(config.ciWriteRepositories.isNotEmpty()) { "gitlab-ci-auth: ciWriteRepositories is required" }
